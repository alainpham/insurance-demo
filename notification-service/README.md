...
This README provides instructions to build and run the notification-service using Docker.
...
```sh
docker rmi alainpham/notification-service
docker build -t alainpham/notification-service .
```

## Pushing to repository

```sh
docker push alainpham/notification-service
```
...
```sh
docker run --rm -p 8080:8080 --name notification-service alainpham/notification-service
```
